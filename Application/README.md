...
We find that vulnerablities only happens in Phase 1 and Phase 2. Also, except for TensorFlow, most of their vulnerabilities are in phase 1. So when IsoPhase is applied to the target application, the most important phase, storing phase (phase4) can be protected from those CVEs.

Below table is the supplementary material for Figure 6 in the paper.
